...
insert into prodotto(nomeProdotto,marcaProdotto,tipoCategoria,tipoProdotto,descrizioneProdotto,prezzoProdotto,numPezziDisponibili) values ('BUGGY RAPTOR 5XB 1/5 HYMOTO', 'HYMOTO', 'Radiocomandato', 'Modello a scoppio', '4x4, motore 32cc, 2.4GHz', 865.00, '[B@7c6c91e0', 3) ; 
insert into prodotto (nomeProdotto, marcaProdotto, tipoCategoria, tipoProdotto, descrizioneProdotto, prezzoProdotto, numPezziDisponibili) values('TRUGGY DESERT KING HIMOTO 1/5','HIMOTO','Radiocomandato','Scoppio','4wd-telecomando con sistema 2.4GHz con ricerca automatica della frequenza.',940.00, '[B@798b9872',3);
insert into prodotto (nomeProdotto, marcaProdotto, tipoCategoria, tipoProdotto, descrizioneProdotto, prezzoProdotto, numPezziDisponibili) values('Rock Crawler 1/10', 'HYMOTO', 'Radiocomandato', 'Elettrico', '-',490.00,'[B@25fa0369', 1);
insert into prodotto (nomeProdotto, marcaProdotto, tipoCategoria, tipoProdotto, descrizioneProdotto, prezzoProdotto, numPezziDisponibili) values('Motoscafo Brushless Fountain', 'HYMOTO', 'Radiocomandato', 'Elettrico. Barca','880BP RTR telecomando con display	HIMOTO	radiocomandato	elettrico	barca radiocomandata in vetroresina, dipinta a mano, con batterie LIPO e caricabatterie.',540.00,'[B@55b679c6', 2);
insert into prodotto (nomeProdotto, marcaProdotto, tipoCategoria, tipoProdotto, descrizioneProdotto, prezzoProdotto, numPezziDisponibili) values('OUTRAGE 2.4G RTR PERFORMANCE', 'NAVICRAFT','Radiocomandato', 'Scoppio-barca','Barca telecomandata, RDR tutto incluso. Alimentazione termica e radiocomando incluso.',870.00, '[B@5906960',3);
insert into prodotto (nomeProdotto, marcaProdotto, tipoCategoria, tipoProdotto, descrizioneProdotto, prezzoProdotto, numPezziDisponibili) values('G LOCOMOTIVA ELETTRICA BR103','PIKO','Radiocomandato', 'elettrico. Ferroviario','-',730.00, '[B@139744a3', 1);
